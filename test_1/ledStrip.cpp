...
LedStrip::LedStrip(uint16_t n, uint8_t p, neoPixelType t) :
...
void LedStrip::updateType(neoPixelType t) {
...
uint32_t LedStrip::getPixelColor(uint16_t n) const {
...
uint16_t LedStrip::numPixels(void) const {
  return numLEDs;
}
...
uint8_t LedStrip::getBrightness(void) const {
  return brightness - 1;
}
